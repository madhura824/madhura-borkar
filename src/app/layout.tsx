...
import { FooterCloud, FooterCloudSmallDevice } from "@/app/assets/icons";
...
{/* <Head>
    ...
    <html lang="en" >
      <body className={twMerge("bg-gray-900 text-white antialiased font-sans m-0 p-0 w-full h-full", inter.variable, calistoga.variable)}>
        ...
        <div className="hidden md:block bg-black/85 blur-3xl w-[100%] h-[30vh] fixed left-0 z-30"></div>
        <div className="fixed left-0 z-30 bg-gradient-to-b from-black  via-black/50 to-transparent w-[100%] h-[50vh]  md:hidden"></div>
