      ...
      <div className='flex flex-col items-center justify-center gap-5 w-full h-full'>
        ...
        <div className='flex flex-1 h-full w-full'>
          <span className={`${poppins.className}  text-gray-400 text-justify text-l sm:text-xl md:text-2xl p-5 md:p-10 w-full`}>{
             ...
             <div>
              {" Hi, i am"} <span className='bg-gradient-to-r from-yellow-200 via-orange-300 to-red-500 text-transparent bg-clip-text'> {"Madhura Borkar"}</span>
              {". I am a "}  <span className='inline-block items-center justify-center relative w-fit '>
                
                
                <div className="relative flex flex-col w-max h-full justify-center items-center">
                  <span className="relative z-10">{"Computer Science "}</span>
                  <span className="absolute inset-0 top-full w-full flex items-center justify-center h-fit ml-3">
                    <Image
                      width={150} // Set a proper width
...
//                   />
//                 </span>
//               </div></span>{" student, currently pursuing a Bachelor of Technology in Computer Science and Engineering. Passionate about technology and problem-solving, I am dedicated to building innovative and efficient solutions across various domains. I have completed a six-month in-office internship at Bugsmirror Research Private Limited, where I sharpened my skills in web development using modern technologies like "}<span className=' relative justify-center items-center max-w-fit !inline-block'><div className='max-w-max h-full'>{"Next.js, TypeScript, and React"}</div> <Image src={'/long-underline.png'} alt='something' className='w-full h-max absolute bottom-0' width={0} height={0} ></Image></span>{". This hands-on experience has allowed me to deepen my understanding of web-development and sharpen my skills in creating responsive, user-centric applications. In addition to web development, I have a strong interest in competitive programming. I regularly solve challenges on platforms such as "}
//               <div className='relative inline w-fit !max-w-full text-wrap p-0 m-0'>
//                 <Button
//                   href={"https://www.geeksforgeeks.org/user/madhurab12/"}
//                   target='_blank'
