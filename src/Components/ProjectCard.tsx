...
export default function ProjectCard( {project}:{project:ProjectDataType}) {
  return (
    <Card className="w-[400px] h-max md:h-[250px] bg-gray-500 backdrop-blur-md bg-opacity-5 border-small border-white border-opacity-10">
      ...
      <Divider/>
      <CardBody className="w-fit h-max">
      <ScrollArea className="h-max w-fit ">
        <p className=" text-gray-300 text-small whitespace-pre-line">{project.Description}</p>
        </ScrollArea>
      </CardBody>
      <Divider className="bg-slate-50 opacity-20"/>
